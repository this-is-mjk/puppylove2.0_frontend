                    ...
                    <div className="grid">
                        <div className="section-1">
                            ...
                            <div className="graphGrid">
                                <HorizontalCharts Data={stats?.batchwiseMatches} Label="Batch Wise Matches"/>
                                <HorizontalCharts Data={stats?.batchwiseRegistration} Label="Batch Wise Registration"/>
                            </div>
                        </div>
                        <div className="section-2">
                            <h1 className="font">Registrations</h1>
                            <div className="doughnutGrid">
                                <DoughnutChart femaleRegistration={stats?.femaleRegisters} maleRegistration={stats?.maleRegisters}/>
                            </div>
                        </div>
                    </div>
                    <Clear/>
